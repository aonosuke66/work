...
public class MigrationTest {
    ...
    public static void main(String[] args) {
        ...
        dataBean2.setSmkGnkCd("1234");
        dataBean2.setSmkStnCd("123");
        dataBean2.setSmkGnkMeiKnz("テスト仕向銀行名");
        dataBean2.setSmkStnMeiKnz("テスト仕向支店名");
        dataBean2.setSokinKngkKozaGokei("123000000000");
        dataBean2.setZysknKinyInstttCd("9876");
        dataBean2.setZysknKinyInstttTnpCd("987");
        dataBean2.setZysknKinyInstttKoyuKnz("テスト送金先銀行名");
        dataBean2.setZysknKinyInstttTnpMeiKnz("テスト送金支店名");
        dataBean2.setZysknKinyInstttYknSymk("2");
        dataBean2.setZysknKinyInstttKozaNmbr("1");
        dataBean2.setKozaMeigninMeiKnz("口座名カナ");
        ...
        dataBean4.setSmkGnkCd("2345");
        dataBean4.setSmkStnCd("234");
        dataBean4.setSmkGnkMeiKnz("テスト仕向銀行名２");
        dataBean4.setSmkStnMeiKnz("テスト仕向支店名２");
        dataBean4.setSokinKngkKozaGokei("234000000000");
        dataBean4.setZysknKinyInstttCd("8765");
        dataBean4.setZysknKinyInstttTnpCd("876");
        dataBean4.setZysknKinyInstttKoyuKnz("テスト送金先銀行名２");
        dataBean4.setZysknKinyInstttTnpMeiKnz("テスト送金支店名２");
        dataBean4.setZysknKinyInstttYknSymk("3");
        dataBean4.setZysknKinyInstttKozaNmbr("2");
        dataBean4.setKozaMeigninMeiKnz("口座名カナ２");
        ...
        dataBean5.setSmkGnkCd("2345");
        dataBean5.setSmkStnCd("234");
        dataBean5.setSmkGnkMeiKnz("テスト仕向銀行名２");
        dataBean5.setSmkStnMeiKnz("テスト仕向支店名２");
        dataBean5.setSokinKngkKozaGokei("234000000000");
        dataBean5.setZysknKinyInstttCd("8765");
        dataBean5.setZysknKinyInstttTnpCd("876");
        dataBean5.setZysknKinyInstttKoyuKnz("テスト送金先銀行名２");
        dataBean5.setZysknKinyInstttTnpMeiKnz("テスト送金支店名２");
        dataBean5.setZysknKinyInstttYknSymk("3");
        dataBean5.setZysknKinyInstttKozaNmbr("2");
        dataBean5.setKozaMeigninMeiKnz("口座名カナ２");
